...
export default function Footer() {
  ...
  return (
    <>
      ...
      <footer className="bg-gradient-to-b from-white to-gray-50/50 border-t border-slate-200 pt-16 pb-8 mt-auto relative overflow-hidden">
        
        {/* Subtle Background Radial Glows & Pattern */}
        <div className="absolute inset-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:24px_24px] opacity-30 z-0 pointer-events-none"></div>
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-blue-100/30 rounded-full blur-[120px] translate-y-1/2 -translate-x-1/4 pointer-events-none z-0"></div>
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-indigo-100/20 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/4 pointer-events-none z-0"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-6 gap-x-12 gap-y-10 mb-10">
            ...
            <div className="col-span-1 md:col-span-1">
              <h4 className="font-extrabold text-gray-900 mb-4 uppercase tracking-wide text-[12px]">Platform</h4>
            ...
            <div className="col-span-1 md:col-span-1">
              <h4 className="font-extrabold text-gray-900 mb-4 uppercase tracking-wide text-[12px]">Resources</h4>
              <ul className="space-y-3 text-[14px]">
            ...
            <div className="col-span-1 md:col-span-1">
              <h4 className="font-extrabold text-gray-900 mb-4 uppercase tracking-wide text-[12px]">Company</h4>
              <ul className="space-y-3 text-[14px]">
          ...
          <div className="border-t border-slate-200 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="inline-flex items-center gap-2 bg-emerald-50/80 backdrop-blur-md text-emerald-700 px-3 py-1.5 rounded-full text-[12px] font-bold border border-emerald-200 shadow-[0_0_15px_rgba(16,185,129,0.15)] cursor-help hover:bg-emerald-100 hover:shadow-[0_0_20px_rgba(16,185,129,0.25)] transition-all">
