      ...
      {isOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 overflow-y-auto">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-2xl bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden my-auto max-h-[90vh] flex flex-col"
          >
            <div className="flex items-center justify-between p-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 flex-shrink-0">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white">I Found This Item!</h2>
            ...
            <div className="overflow-y-auto p-6">
              {submitted ? (
                <div className="text-center py-8">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Item Reported Found!</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="bg-blue-50 p-4 rounded-xl border border-blue-100 mb-2">
                    ...
                    <div className="bg-white dark:bg-gray-800/60 p-3 rounded-lg border border-blue-200/50">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className="w-full pl-10 border-2 border-gray-200 dark:border-gray-600 rounded-xl p-3 focus:border-cyan-500 focus:ring-0 outline-none transition-colors"
