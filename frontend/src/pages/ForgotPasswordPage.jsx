...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="flex justify-center items-center py-24 px-4 min-h-[calc(100vh-4rem)] relative overflow-hidden">
      ...
      <div className="glass-card p-10 rounded-3xl max-w-md w-full relative z-10 border border-white/50 shadow-[0_20px_60px_rgba(0,82,255,0.05)]">
        ...
        <AnimatePresence mode="wait">
          {!isSubmitted ? (
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-10 pr-3 py-3.5 bg-white/50 backdrop-blur-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#0052FF] focus:border-[#0052FF] outline-none transition-all text-[15px] shadow-inner"
                      required
                    />
                  </div>
                </div>
            ...
            >
              ...
              <h3 className="text-2xl font-extrabold text-gray-900 mb-3">Check Your Email</h3>
              ...
              <Link 
                to="/login"
                className="w-full inline-block bg-white text-gray-900 border border-gray-200 font-bold py-3 rounded-xl hover:bg-gray-50 shadow-sm transition-all text-[15px]"
              >
                Return to Login
              </Link>
            </motion.div>
